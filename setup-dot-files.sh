...
curl -L https://raw.githubusercontent.com/chafey/dot-files/master/.smb > $HOME/.smb
curl -L https://raw.githubusercontent.com/chafey/dot-files/master/.vimrc > $HOME/.vimrc
curl -L https://raw.githubusercontent.com/chafey/dot-files/master/.zshrc > $HOME/.zshrc
